...
\title{\textcolor{red}{\textbf{A type system for data flow and alias analysis in ReScript}}}

\author{\textcolor{white}{Nicky Ask Lund  \and Hans Hüttel}}
\date{\textcolor{white}{September 2024} \\[4mm]
  \textcolor{yellow}{\textbf{COPLAWS 2024}} \\[4mm]
\textcolor{white}{\textsl{To appear at Applied Formal Methods
...
[width=\paperwidth,height=\paperheight]{timisoara.jpg}}
\maketitle
}
