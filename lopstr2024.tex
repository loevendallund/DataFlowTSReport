...
Furthermore, an implementation for the type system were also made, to showcase
the the type system. The implementation is made in the Rust programming language
and includes a parser, and evaluator, a type checker, and an approximator for an
order of programs points. The approximator is based on the given type system,
where it is derived from the structure of the type system.
