...
An implementation for the semantics and type system presented in this paper.
The implementation is made in the Rust programming language and includes a parser,
an evaluator, the typing of the language, and approximating the order of program points.
The approximation of program points is derived from the structure of the type system,
as the order can be derived from the type rule and the premises.
The implementation is hosted on Github and can be found at \cite{df_implementation}.
